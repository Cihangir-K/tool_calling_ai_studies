...
tools = [tavily_search,get_now,take_a_note]
...
templete = """Answer the following questions as best you can. 
...
while True:
    ...
    # parsed_output=parsed_output = output_parser.parse(str(result))
    # print("###################################")
    # print("AI Final answeR:",parsed_output)
    # print("###################################")
